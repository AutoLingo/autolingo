...
// var mapbox = new MapboxClient('pk.eyJ1IjoidGhsZWUxMTIyIiwiYSI6ImNpeWdyd2tycDAzZTUzMm12eDcybjJocTgifQ.r1njnGgI95MNlwVBTm1slw');

import ReactDOM from 'react-dom'
import { Map, TileLayer } from 'react-leaflet'
const position = [16.541430, 7.558594]
    ...
    return (
      <div>
        <Map
          ...
          zoom={10}>
          <TileLayer
            url="https://api.mapbox.com/styles/v1/thlee1122/ciyhpbj15003d2sluqt6ylrqa/tiles/256/{z}/{x}/{y}?access_token=pk.eyJ1IjoidGhsZWUxMTIyIiwiYSI6ImNpeWdyd2tycDAzZTUzMm12eDcybjJocTgifQ.r1njnGgI95MNlwVBTm1slw"
...
//
//     //Disable zooming, scrolling, and dragging
